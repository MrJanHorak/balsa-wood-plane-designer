...
import { AlertTriangle, CheckCircle2, Scale, Compass, Wrench, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-3 p-4 rounded-xl border border-slate-800 bg-slate-900/90 backdrop-blur-md shadow-xl">
      ...
      <div className="space-y-1 pt-1">
        ...
        {/* Legend beneath beam */}
        <div className="flex flex-wrap items-center justify-between gap-x-2 gap-y-1 pt-0.5 text-xs">
      ...
      <div className={`p-3 rounded-lg border ${colors.bg} flex items-start gap-2.5`}>
        ...
        <div className="flex-1 text-xs space-y-1">
          ...
          <p className="text-xs text-slate-300">
            <strong>Model indication:</strong> {aeroReport.pitchTendencyDescription}
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 pt-1">
        <div className="text-xs">
          <span className="text-slate-300">Estimated nose ballast: </span>
        ...
        >
          <span>Set design ballast ({recommendedBallastGrams}g)</span>
        </button>
      </div>
    </div>
  );
